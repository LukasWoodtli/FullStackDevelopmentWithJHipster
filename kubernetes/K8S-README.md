...
```
$ docker image tag invoice lukaswoodtli/invoice
$ docker push lukaswoodtli/invoice
$ docker image tag notification lukaswoodtli/notification
$ docker push lukaswoodtli/notification
$ docker image tag store lukaswoodtli/store
$ docker push lukaswoodtli/store
```
