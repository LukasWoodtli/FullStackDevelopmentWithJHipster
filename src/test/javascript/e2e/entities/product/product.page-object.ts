...
export class ProductUpdatePage {
  ...
  productSizeSelect = element(by.id('field_productSize'));
  ...
  async setProductSizeSelect(productSize: string): Promise<void> {
    await this.productSizeSelect.sendKeys(productSize);
  }

  async getProductSizeSelect(): Promise<string> {
    return await this.productSizeSelect.element(by.css('option:checked')).getText();
  }

  async productSizeSelectLastOption(): Promise<void> {
